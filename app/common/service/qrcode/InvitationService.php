...
class InvitationService extends Base
{
    ...
    public function getImage()
    {
        ...
        if($this->source == 'wx'){
            // 下载小程序码
            $this->saveInvitQrcodeToDir($invitation['app_id'], 'pages/index/index', $savePath, $this->id);
        }else if($this->source == 'mp' || $this->source == 'h5'){
            $this->saveInvitMpQrcodeToDir('h5/pages/index/index', $savePath, $this->id, $invitation['app_id']);
        }
